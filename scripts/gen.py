...
def generate_entry_debug_code(t, fname, params, fname_ns=None, add_scope=False):
  ...
  if add_scope or _PUSH_SCOPE:
    code += '  ir::ScopePusher _push_scope("{}::{}");\n'.format(fname_ns, fname)
...
if __name__ == '__main__':
  ...
  arg_parser.add_argument(
    '--push_scope',
    type=str,
    help='Push scope for functions (for debugging purposes)',
    default=False)
  arg_parser.add_argument(
      'xlatype',
      type=str,
